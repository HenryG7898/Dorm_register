        ...
        <div class="sm:mx-auto lg:mx-auto w-full h-full pt-12 pb-10 bg-white
            ...
            <section
                ...
                <div>
                    ...
                    @endif
                    <div>
                        <h2 class="text-3xl font-bold mb-10 text-gray-800 text-center">New Room</h2>
                        ...
                        <form class="space-y-5 space-x-1" wire:submit.prevent="newroom">
                            <div class=" gap-6 mt-4 sm:grid-cols-2">
                                <div>
                                    ...
                                    <input type="text" wire:model="dorm_room" id="" class="w-full border-2 border-gray-200 p-3 rounded outline-none focus:border-purple-500">
                                    @error('dorm_room') <span class="error text-red-600">{{ $message }}</span> @enderror
                                </div>
                            </div>
